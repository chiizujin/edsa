...
One is "Grendel Jungle" and the other is "Grendel Jungle (Remove)". I hope it's
...
between the jungle and the Docking Station. These can be moved to anywhere you
...
1.1
- Changed the default position of the teleporter in the jungle as it was too
  near a roof for creatures over a certain size.
